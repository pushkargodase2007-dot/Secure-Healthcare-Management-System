...
<!-- Navbar Start -->
        ...
        <div class="container-fluid pt-5">
            <div class="container">
                <br><br><br><br>
                <center><h1>Key Verification</h1></center>
                    <br><br><br><br><br><br>
                <div class="row justify-content-center position-relative" style="margin-top: -200px; z-index: 1;">
                    <div class="col-lg-8">
                        <div class="bg-white rounded p-5 m-5 mb-0">
                            <form action="ViewResults.jsp" method="post">
                            <div class="row g-3">
                                <label style="color: black">Patient Id</label>
                                <div class="col-12">
                                    <input type="text" class="form-control bg-light border-0" name="pid" value="<%=pid%>" required="" placeholder="PID" style="height: 55px;">
                                </div>
                                <input type="hidden" name="accesspol" value="<%=accesspol%>">
                                 <label style="color: black">Decryption Key</label>
                                <div class="col-12">
                                    <input type="text" class="form-control bg-light border-0" name="ss" required="" placeholder="Decryption Key" style="height: 55px;">
                                </div>
                                <div class="col-12">
                                    <button class="btn btn-primary w-100 py-3" type="submit">Decrypt</button>
                                </div>
                            </div>
                        </form>
                            <br><br><br><br><br>
