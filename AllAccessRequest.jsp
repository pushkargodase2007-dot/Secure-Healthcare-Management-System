                ...
                <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav ms-auto py-0">
                            ...
                            <a href="AllAccessRequest.jsp" class="nav-item nav-link  active ">All Request</a>
            ...
            <div class="container">
                <div class="row justify-content-center position-relative" style="margin-top: -200px; z-index: 1;">
                    <div class="col-md-12">
                        ...
                        <center><h1>Access Request</h1></center>
                        <br> <br> <br>
                        <table id="naresh" style="margin: auto;padding: 10px;">
                            ...
                            <%
                                ...
                                try {
                                    ResultSet rs = st.executeQuery("Select * from mdatarequest where reqstatus='Approved' ");
                                    while (rs.next()) {
                            %>
                            <tr>
