                ...
                <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav ms-auto py-0">
                            ...
                            <a href="Upload.jsp" class="nav-item nav-link">Upload</a>
                            <a href="Myrecord.jsp" class="nav-item nav-link">Medical Record</a>
                            <a href="AccessDetails.jsp" class="nav-item nav-link active ">Access Details</a>
            ...
            <div class="container">
                <div class="row justify-content-center position-relative" style="margin-top: -200px; z-index: 1;">
                    <div class="col-md-12">
                        ...
                        <center><h1>Requested Details</h1></center>
                        <br> <br> <br>
                        <table id="naresh" style="margin: auto;padding: 10px;">
                            ...
                            <%
                                ...
                                try {
                                    ResultSet rs = st.executeQuery("Select * from mdatarequest where pid='"+pid+"' and reqstatus='Approved' ");
                                    while (rs.next()) {
                            %>
                            <tr>
