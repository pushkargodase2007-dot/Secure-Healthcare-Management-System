                ...
                <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav ms-auto py-0">
                            ...
                            <a href="Patient.jsp" class="nav-item nav-link active">Patient</a>
                    ...
                    <div class="col-lg-8">
                        <div class="bg-white rounded p-5 m-5 mb-0">
                            <form action="PatientLog" method="post">
                                <div class="row g-3">
                                    <div class="col-12">
                                        <input type="email" name="email" required="" class="form-control bg-light border-0" placeholder="Your Email" style="height: 55px;">
                                    </div>
                                    <div class="col-12">
                                        <input type="password" name="password" required="" class="form-control bg-light border-0" placeholder="Password" style="height: 55px;">
                                    </div>
                                    <center> <div class="col-5">
                                            <button class="btn btn-primary w-100 py-3" type="submit">Login</button>
                                        </div></center>
                                </div>
                                <center><br><a href="PatientReg.jsp" style="color: red">New Patient Registration</a></center>
                            </form>
                            <br><br><br><br><br>
