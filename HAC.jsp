...
<html lang="en">
    ...
    <body>
                ...
                <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav ms-auto py-0">
                            ...
                            <a href="HAC.jsp" class="nav-item nav-link active">Healthcare Administration(HAC)</a>
        ...
        <div class="container-fluid pt-5">
            <div class="container">
                <br><br><br><br>
                <center><h1>Healthcare Administration Center(HAC)</h1></center>
                    <br><br><br><br><br><br>
                ...
                <div class="row justify-content-center position-relative" style="margin-top: -200px; z-index: 1;">
                    <div class="col-lg-8">
                        <div class="bg-white rounded p-5 m-5 mb-0">
                            <form action="HACLog" method="post">
                                <div class="row g-3">
                                    <div class="col-12">
                                        <input type="text" required="" name="name" class="form-control bg-light border-0" placeholder="Username" style="height: 55px;">
                                    </div>
                                    <div class="col-12">
                                        <input type="password" required="" name="password" class="form-control bg-light border-0" placeholder="Password" style="height: 55px;">
                                    </div>
